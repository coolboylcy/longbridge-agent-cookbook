...
const zhCN: HubContent = {
  meta: {
    ...
    description:
      "可直接运行的 AI Agent 食谱。把 Prompt 粘贴到 Claude Code，你的 Agent 终于看得到你的自选股。不用写代码。",
  },
  nav: {
    brand: "Cookbook",
    links: [
  ...
  hero: {
    ...
    title: "把券商塞进你的 Agent。",
    description:
      "为 Longbridge 设计的 AI Agent 食谱。粘进 Claude Code，你的 Agent 立刻有了券商手脚 — 自选股、报价、期权链、持仓、模拟下单。不写代码。",
    primaryCta: "浏览食谱",
