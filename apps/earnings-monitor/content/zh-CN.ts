    ...
    steps: [
      {
        ...
        body: "二选一：CLI（brew install --cask longbridge/tap/longbridge-terminal，再 `longbridge auth login`，最后 `longbridge init F6HEGJ` 完成归因）或 MCP（把 https://openapi.longbridge.com/mcp 加到客户端配置）。OAuth 自动处理登录。",
      },
      {
        title: "安装 Skill",
