    ...
    steps: [
      {
        ...
        body: "二選一：CLI（brew install --cask longbridge/tap/longbridge-terminal，再 `longbridge auth login`，最後 `longbridge init F6HEGJ` 完成歸因）或 MCP（把 https://openapi.longbridge.com/mcp 加到客戶端設定）。一次性 OAuth。",
      },
      {
        title: "安裝 Skill",
